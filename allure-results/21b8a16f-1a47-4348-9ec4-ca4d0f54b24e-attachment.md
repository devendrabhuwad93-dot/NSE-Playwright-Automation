...
```ts
  ...
  37 |         console.log(
  38 |         'Search Box Count:',
  39 |         await this.searchBox.count()
  40 |         );
> 41 |         await this.searchBox.click();
     |                              ^ Error: locator.click: Error: strict mode violation: locator('//input[contains(@placeholder,\'Search\')]') resolved to 2 elements:
  42 | 
  43 |         // Enter HDFC
  44 |         await this.searchBox.fill('HDFC');
  45 | 
  46 |         // Wait for dropdown suggestion
  47 |         await expect(this.hdfcBankOption).toBeVisible({
  48 |             timeout: 10000
  49 |         });
  50 | 
  51 |         // Hover on dropdown option
  52 |         await this.hdfcBankOption.hover();
  53 | 
  54 |         // Click HDFC BANK option
  55 |         await this.hdfcBankOption.click();
  56 |     }
  57 | }
```