...
Call log:
  - waiting for locator('div.autocompleteList.tt-suggestion.tt-selectable.active')
...
```ts
  ...
  43 | 
  44 |         const stockOption = this.page.locator('div.autocompleteList.tt-suggestion.tt-selectable.active');
  45 | 
> 46 |         await stockOption.hover();
     |                           ^ Error: locator.hover: Target page, context or browser has been closed
  47 | 
  48 |         await stockOption.click();
  49 |     }
  50 | }
  51 | 
```